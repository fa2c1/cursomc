...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Produto p2 = new Produto(null, "Impŕessora", 800.00);
		...
		Cliente cli1 = new Cliente(null, "Maria silva", "mariasilva@gmail", "36378912377", "15248561", TipoCliente.PESSOAFISICA);
		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apyo 303", "Jardins", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "195", "Sala 800", "Centro", "17777012", cli1, c2);
